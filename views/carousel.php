...
try {
    ...
    $data_json = file_get_contents("http://diskominfopamekasan.my.id/api/get_data.php?tanggal=" . $selected_date);
    ...
    <div class="row gx-3 gy-3">
        <?php foreach ($data as $info): ?>
            <?php 
                ...
                // Menentukan warna berdasarkan status harga
                if ($info["status"] === "naik") {
                    $color = "red";
                } elseif ($info["status"] === "turun") {
                    $color = "yellow";
                } else {
                    $color = "green"; // Jika harga tetap
                }
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="price-card">
                    <div class="card-left">
                        ...
                        <span class="price-change <?= $color ?>">
                            <i class="lni <?= ($info["status"] === "naik") ? 'lni lni-arrow-up' : 'lni lni-arrow-down' ?>"></i>
